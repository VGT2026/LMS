...
import { optionalCourseImageUpload } from '../middleware/courseImageUpload';
...
router.post('/', authenticate, requireInstructorOrAdmin, optionalCourseImageUpload, [
...
router.put('/:id', authenticate, requireInstructorOrAdmin, optionalCourseImageUpload, updateCourse);
